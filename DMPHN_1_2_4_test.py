...
def main():
    ...
    for images_name in os.listdir(SAMPLE_DIR):
    	with torch.no_grad():             
            ...
            #将lv2的Encoder输出进行拼接，并且与lv3的Encoder进行相加
            ...
            #将原尺寸的图像和lv2的Decoder输出相加送入lv1的Encoder，Encoder输出与lv2的Encoder输出相加
            feature_lv1 = encoder_lv1(images_lv1 + residual_lv2) + feature_lv2
            #将lv1的特征输入Decoder，得到输出的图像
